...
Namespace SolidEdgeSDK.AddIn
    ...
    Public MustInherit Class SolidEdgeAddIn
        ...
        Public Function AddWpfEdgeBarPage(Of TControl As {System.Windows.Controls.Page, New})(ByVal config As EdgeBarPageConfiguration, ByVal Optional document As SolidEdgeFramework.SolidEdgeDocument = Nothing) As EdgeBarPage
